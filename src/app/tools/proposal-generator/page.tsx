...
import { FileText, Download, User, Building, Mail, Phone, Calendar, CheckCircle, Edit2, Send } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      <div className="max-w-3xl mx-auto p-6">
        ...
        {step === 2 && (
          <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
            ...
            <div className="flex gap-3 mt-6">
              <button onClick={prevStep} className="flex-1 py-4 bg-slate-700 hover:bg-slate-600 rounded-xl font-semibold transition">
                ← Terug
              </button>
              <button
                onClick={nextStep}
        ...
        {step === 3 && (
          <div className="space-y-4">
            <div className="bg-slate-800 rounded-2xl p-6 border border-slate-700">
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-xl focus:ring-2 focus:ring-violet-500 outline-none resize-none"
                />
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-violet-600 to-purple-600 rounded-2xl p-6">
              ...
              <p className="text-white/80 text-sm mb-4">Genereer een PDF-achtig tekstbestand dat je kunt versturen</p>
              <button
            ...
            {generated && (
              <div className="bg-green-500/20 border border-green-500/30 rounded-xl p-4">
                ...
                <p className="text-sm text-slate-300">Het bestand is gedownload. Je kunt het nu aanpassen en versturen.</p>
                <button
                  onClick={downloadProposal}
                  className="mt-3 px-4 py-2 bg-green-600 hover:bg-green-700 rounded-xl font-medium text-sm transition"
                >
                  Download opnieuw
                </button>
              </div>
        ...
        {/* CTA */}
        <div className="mt-8 bg-slate-800 rounded-2xl p-6 border border-slate-700 text-center">
          <p className="text-slate-400 mb-4">Wil je dat wij dit voorstel voor je opstellen en versturen?</p>
          <a href="/#contact" className="inline-block px-6 py-3 bg-violet-600 hover:bg-violet-700 rounded-xl font-semibold transition">
            Neem contact op →
          </a>
        </div>
      </div>
